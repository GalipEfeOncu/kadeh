export const gin = [
  ...
  },
  {
    ...
    hammadde: `10 botanik: ardıç, kişniş, limon kabuğu, melek otu, kubeb biberi, Süsen kökü, cenneti tohumu, meyan kökü, badem, Çin tarçını. Nötr tahıl alkolü.`,
  ...
  },
  {
    ...
    hammadde: '11 botanik (ardıç, kişniş, melek otu kökü, süsen kökü, limon kabuğu, portakal kabuğu, kübabe biberi, frenk kimyonu, papatya, mürver çiçeği, civanperçemi) + salatalık ve gül yaprakları infüzyonu',
  ...
  },
  {
    ...
    emoji: '🍸',
    color: '#e60000',
    aliases: ["Gordon's", "Sarı Etiketli Cin"],
    origin: 'İngiltere',
    ana_tur: 'gin',
    alt_tur: 'london_dry',
    gorunum: 'berrak',
    olgunlasma: 'dinlendirilmemiş',
    aroma: ['ardıç', 'narenciye', 'baharat'],
    alkol_seviye: 'sert',
    lore_short: 'Dünyanın en çok satan London Dry cini. Klasik G&T kokteylinin değişmez yüzü ve bar dolaplarının demirbaşı.',
    lore_full: [
      { baslik: 'Köken', metin: "1769 yılında Alexander Gordon tarafından Londra'da kuruldu. Orijinal reçetesi hala sır gibi saklanır." },
      { baslik: 'Yayılma', metin: "İngiliz donanması sayesinde tüm dünyaya yayıldı. Hem sarayların hem de pubların ortak içkisi oldu." },
      { baslik: 'Kültürel Etki', metin: "James Bond'un efsanevi Vesper kokteylinde adını geçirerek popüler kültürde ölümsüzleşti." },
      { baslik: 'Modern Dönem', metin: "Günümüzde Diageo çatısı altında, fiyat-performans oranıyla cin dünyasının temel taşıdır." },
      { baslik: 'Türkiye ile İlişkisi', metin: "Türkiye'de cin tonik denildiğinde akla ilk gelen markalardan biridir, çok yaygındır." }
    ],
    hammadde: 'Nötr buğday alkolü, ardıç, kişniş tohumu ve çeşitli gizli botanikler.',
    uretim_sureci: 'Klasik pot still damıtımı.',
    dinlendirme: 'Dinlendirilmez.',
    renk: 'Kristal berrak.',
    koku: 'Güçlü ardıç ve narenciye kabuğu.',
    tat: 'Kuru, ardıç baskın, temiz ve net.',
    finish: 'Kısa ve taze.',
    vucut: 'Medium body',
    rakon: 'mix',
    sek_detay: { kadeh: 'Shot', sicaklik: 'Soğuk', miktar: '40 ml', hazirlik: 'Genelde sek içilmez.' },
    mix_detay: [ { isim: 'Gordon\'s Tonic', malzemeler: ['50 ml Gordon\'s', '150 ml Tonik', 'Limon dilimi'], hazirlanis: 'Buzlu bardağa cin ve tonik eklenir, limon ile süslenir.', neden: 'Klasik London Dry yapısı tonikle mükemmel uyum sağlar.', ortam: 'Pub, parti, rahat bir akşam.' } ],
    yiyecek: 'Tuzlu fıstık, cips, hafif atıştırmalıklar.',
    muzik_his: 'Pop, Rock, Mainstream.',
    mevsim: 'Yaz',
    abv_range: '37.5',
    standart_porsiyon: '50',
    kafa_dozu: { hafif: '1-2 kadeh', ideal: '3-4 kadeh', limit_ustu: '5+ kadeh', ertesi_gun: 3 },
    etki_hizi: 'Orta', metabolizma: 'Hızlı',
    baslangic_onerileri: ["Gordon's"], orta_seviye: ["Gordon's Premium Pink"], premium: ['-'],
    fiyat_araligi: '400 - 600', nereden_alinir: 'Tekeller, marketler, publar.',
    pop_kultur: 'James Bond Casino Royale.', yanlis_bilinenler: 'Sadece ucuz bir cin olduğu sanılır, oysa kalitesi yıllara meydan okumuştur.', sozler: '"The world\'s favorite gin."'
  },
  {
    id: 'beefeater',
    ...
    emoji: '💂',
    color: '#cc0000',
    aliases: ['Beefeater', 'Kırmızı Muhafız'],
    origin: 'İngiltere',
    ana_tur: 'gin',
    alt_tur: 'london_dry',
    gorunum: 'berrak',
    olgunlasma: 'dinlendirilmemiş',
    aroma: ['ardıç', 'acı portakal', 'limon'],
    alkol_seviye: 'sert',
    lore_short: 'Londra\'nın tam kalbinde damıtılmaya devam eden gerçek bir klasik. Portakal notalarıyla zenginleşen ikonik bir reçete.',
    lore_full: [
      { baslik: 'Köken', metin: "1863 yılında James Burrough tarafından yaratıldı. İsmini Londra Kalesi'nin meşhur muhafızlarından alır." },
      { baslik: 'Yayılma', metin: "Dünyanın en çok ödül alan cin markalarından biri olarak Amerika pazarında büyük sükse yapmıştır." },
      { baslik: 'Kültürel Etki', metin: "Klasik kokteyllerin (Negroni, Martini) orjinal reçetelerinde sıkça aranan bir markadır." },
      { baslik: 'Modern Dönem', metin: "Hala Londra içinde (Kennington) damıtılan nadir büyük cin markalarındandır." },
      { baslik: 'Türkiye ile İlişkisi', metin: "Kaliteli kokteyl barlarının vazgeçilmez dökme (well) cinlerindendir." }
    ],
    hammadde: '9 farklı botanik: ardıç, acı portakal kabuğu, limon kabuğu, kişniş, badem, vb.',
    uretim_sureci: 'Botanikler damıtılmadan önce alkol içinde 24 saat bekletilir (steeping).',
    dinlendirme: 'Dinlendirilmez.',
    renk: 'Berrak.',
    koku: 'Narenciye, özellikle acı portakal ve güçlü ardıç.',
    tat: 'Meyvemsi ama kuru, kompleks ve güçlü.',
    finish: 'Orta uzunlukta, hafif tatlı baharatlı.',
    vucut: 'Medium to Full body',
    rakon: 'mix',
    sek_detay: { kadeh: 'Martini', sicaklik: 'Çok Soğuk', miktar: '50 ml', hazirlik: 'Martini olarak ideal.' },
    mix_detay: [ { isim: 'Classic Negroni', malzemeler: ['30 ml Beefeater', '30 ml Campari', '30 ml Tatlı Vermut'], hazirlanis: 'Buzla karıştırılır, portakal kabuğuyla servis edilir.', neden: 'Güçlü ardıç karakteri Campari\'nin acılığına karşı dimdik durur.', ortam: 'Aperitivo saati.' } ],
    yiyecek: 'Charcuterie tahtası, zeytin, bruschetta.',
    muzik_his: 'Klasik Jazz, Soul.',
    mevsim: 'Her mevsim',
    abv_range: '40 - 47',
    standart_porsiyon: '50',
    kafa_dozu: { hafif: '1-2 kadeh', ideal: '3 kadeh', limit_ustu: '4+ kadeh', ertesi_gun: 2 },
    etki_hizi: 'Orta', metabolizma: 'Hızlı',
    baslangic_onerileri: ['Beefeater London Dry'], orta_seviye: ['Beefeater 24'], premium: ['Burrough\'s Reserve'],
    fiyat_araligi: '500 - 750', nereden_alinir: 'Tekeller ve barlar.',
    pop_kultur: 'Londra ruhunun sıvı hali.', yanlis_bilinenler: 'Sıradan bir cin olduğu düşünülür ama çok kompleks bir üretim süreci vardır.', sozler: '"The Spirit of London."'
  },
  {
    id: 'tanqueray-ten',
    ...
    gorunum: 'berrak',
    olgunlasma: 'dinlendirilmemiş',
    aroma: ['taze narenciye', 'papatya', 'ardıç'],
    alkol_seviye: 'sert',
    lore_short: 'Taze narenciyelerle damıtılan ilk ultra-premium cin. Adını yapımında kullanılan 10 numaralı küçük imbikten alır.',
    lore_full: [
      { baslik: 'Köken', metin: "2000 yılında piyasaya sürüldü. Kurutulmuş kabuklar yerine taze greyfurt, portakal ve misket limonu kullanılır." },
      { baslik: 'Yayılma', metin: "Premium cin kategorisini tanımlayan öncü ürünlerden biri oldu." },
      { baslik: 'Kültürel Etki', metin: "San Francisco World Spirits Competition'da Hall of Fame'e giren tek cindir." },
      { baslik: 'Modern Dönem', metin: "Lüks barların ve miksolojistlerin Martini için en çok tercih ettiği markalardan biridir." },
      { baslik: 'Türkiye ile İlişkisi', metin: "Özel kutlamaların ve lüks otel barlarının aranan ismidir." }
    ],
    hammadde: 'Taze greyfurt, portakal, lime, papatya ve klasik Tanqueray botanikleri.',
    uretim_sureci: 'Küçük Tiny Ten imbiğinde (Number 10) küçük partiler halinde damıtılır.',
    dinlendirme: 'Dinlendirilmez.',
    renk: 'Berrak.',
    koku: 'Taze kesilmiş greyfurt ve papatya, arkadan gelen ardıç.',
    tat: 'İnanılmaz pürüzsüz, narenciye patlaması, zarif çiçeksi dokunuşlar.',
    finish: 'Uzun, tazeleyici ve zarif.',
    vucut: 'Full body',
    rakon: 'mix',
    sek_detay: { kadeh: 'Copa', sicaklik: 'Soğuk', miktar: '50 ml', hazirlik: 'Bol buzla sek bile yudumlanabilir.' },
    mix_detay: [ { isim: 'T10 Martini', malzemeler: ['60 ml Tanqueray No. TEN', '10 ml Kuru Vermut', 'Greyfurt kabuğu'], hazirlanis: 'Buzla nazikçe karıştırılır ve süzülür.', neden: 'Taze narenciye profili kusursuz bir Martini yaratır.', ortam: 'Fine dining, lüks lounge.' } ],
    yiyecek: 'İstiridye, havyar, taze deniz ürünleri.',
    muzik_his: 'Lounge, Klasik Müzik.',
    mevsim: 'İlkbahar ve Yaz',
    abv_range: '47.3',
    standart_porsiyon: '50',
    kafa_dozu: { hafif: '1 kadeh', ideal: '2-3 kadeh', limit_ustu: '4+ kadeh', ertesi_gun: 1 },
    etki_hizi: 'Hızlı', metabolizma: 'Hızlı',
    baslangic_onerileri: ['Tanqueray'], orta_seviye: ['Tanqueray No. TEN'], premium: ['-'],
    fiyat_araligi: '1200 - 1800', nereden_alinir: 'Premium tekel bayileri.',
    pop_kultur: 'Barmenlerin sevgilisi.', yanlis_bilinenler: 'Sadece 10 botanik olduğu sanılır, adı aslında kullanılan 10 numaralı imbikten gelir.', sozler: '"The ultimate Martini gin."'
  }
];
